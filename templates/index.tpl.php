...
<body>
    <header>
        ...
        <form method="get" action="http://www.google.com/search" target="_blank">
            ...
            <input type="hidden" name="sitesearch" value="<?=(isset($_SERVER['HTTPS']) && $_SERVER['HTTPS'] === 'on' ? "https" : "http") . "://$_SERVER[HTTP_HOST]" ?>">
        </form>
    </header>
    <div id="wrapper">
        <aside id="nav">
    ...
    <footer>
        <?php if(isset($lablec['copyright'])) { echo $lablec['copyright'] ?> <?php } ?>
        &nbsp;
